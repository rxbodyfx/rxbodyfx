  ...
  return (
    <Layout>
      ...
      <section className="max-w-2xl mx-auto px-6 py-28 text-center">
        <p className="eyebrow text-clay-dark mb-4">404</p>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          ...
          <Link href="/services/" className="border border-pine-800/30 px-6 py-3 rounded-full font-medium hover:border-clay hover:text-clay-dark transition-colors">
            View Services
          </Link>
          <Link href="/contact/" className="border border-pine-800/30 px-6 py-3 rounded-full font-medium hover:border-clay hover:text-clay-dark transition-colors">
            Contact Us
          </Link>
        </div>
      </section>
